...
async def read_note(note_id: int, db: AsyncSession = Depends(get_db), user: User = Depends(get_current_user)):
    note_service = NoteService(db)
...
async def create_note(body: NoteModel, db: AsyncSession = Depends(get_db), user: User = Depends(get_current_user)):
    note_service = NoteService(db)
...
async def update_note(
        body: NoteUpdate, note_id: int, db: AsyncSession = Depends(get_db), user: User = Depends(get_current_user)
):
    note_service = NoteService(db)
...
async def update_status_note(
        body: NoteStatusUpdate, note_id: int, db: AsyncSession = Depends(get_db), user: User = Depends(get_current_user)
):
    note_service = NoteService(db)
...
async def remove_note(note_id: int, db: AsyncSession = Depends(get_db), user: User = Depends(get_current_user)):
    note_service = NoteService(db)
